 ...
 */
#ifndef MAX_BURST_RX
#define MAX_BURST_RX 512
#endif

#ifndef MAX_BURST_TX
#define MAX_BURST_TX 512
#endif
...
/* This function drains the UMEM completion queue (CQ), returning all completed
 * buffers to the buffer cache. It is essential for preventing buffer leaks.
 */
...
#define TOTAL_NUM_BUFFERS (128 * 1024) // This is 131,072
static const struct bpool_params bpool_params_default = {
    .n_buffers = TOTAL_NUM_BUFFERS,
